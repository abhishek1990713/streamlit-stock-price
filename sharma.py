...
urllib.request.urlretrieve( "https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/dataframe_linear_model_pickle.pkl?raw=true", "dataframe_linear_model_pickle.pkl")

urllib.request.urlretrieve(
    "https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/dataframe_poly_model_pickle.pkl?raw=true", "dataframe_poly_model_pickle.pkl")

urllib.request.urlretrieve(
    "https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/MSFT_linear_model_pickle.pkl?raw=true", "MSFT_linear_model_pickle.pkl")

urllib.request.urlretrieve(
    "https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/MSFT_poly_model_pickle.pkl?raw=true", "MSFT_poly_model_pickle.pkl")


@st.cache
def load_data(nrows):
    data = pd.read_csv('https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/test.csv',
                       nrows=nrows)
    return data
...
def load_msft_data(nrows):
    data = pd.read_csv('https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/Datasets/MSFT.csv',
                       nrows=nrows)
    return data
...
def load_nfty_data(nrows):
    data = pd.read_csv('https://github.com/abhishek1990713/Prediction-of-Stock-Price-Movement-based-on-trading-DS-II/blob/main/Datasets/DataFrame.csv',
                       nrows=nrows)
    return data
...
if st.checkbox("Show Credits"):
    ...
    st.sidebar.info("[Project Report](https://drive.google.com/drive/u/0/folders/0B1eSbAsMM-69QnJ3NlpHcUlTSTA?resourcekey=0-cMRMrjrV0mtWK_BLJnAlOw/edit?usp=sharing)\n")
